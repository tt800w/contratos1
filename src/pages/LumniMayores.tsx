  ...
  const handePreview = async () => {
    ...
    try {
      ...
      const data = {
        ...
        "EMAIL CAMPER": raw.emailRepresentante, // Assuming the contact email is in this column
        "CELULAR CAMPER": raw.celularCamper,
        "NOMBRE COMPLETO REP": raw.nombreRepresentante, // Added based on screenshot
        "CEDULA REP DEL CAMPER": raw.cedulaRepresentante, // Added based on screenshot
        "EMAIL REP CAMPER": raw.emailRepresentante, // Fallback if needed
        "dia": dia,
        "mes": mes,
        "año": ano,
