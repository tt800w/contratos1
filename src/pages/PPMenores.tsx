    ...
    const handePreview = async () => {
        ...
        try {
            ...
            const blob = await generateContract(
                "/contratos/Condiciones Específicas-Pronto Pago Menor de Edad.docx",
                data,
                "preview.docx",
                true
            );
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <div className="flex h-[calc(100vh-65px)]">
                                ...
                                <div>
                                    ...
                                    {selectedUserData && (
                                        <div className="mt-1 text-[10px] text-muted-foreground bg-secondary/30 p-2 rounded">
                                            <p><strong>Rep:</strong> {selectedUserData.raw.nombreRepresentante}</p>
                                            <p><strong>Cédula:</strong> {selectedUserData.raw.cedulaRepresentante}</p>
                                        </div>
                                    )}
                                </div>
                            )}
                        ...
                        <div className="grid grid-cols-2 gap-2 mt-2">
                                ...
                                onClick={async () => {
                                    ...
                                    try {
                                        ...
                                        await generateContract(
                                            "/contratos/Condiciones Específicas-Pronto Pago Menor de Edad.docx",
                                            data,
                                            `Contrato_PP_Menores_${raw.nombreCamper.replace(/\s+/g, '_')}.docx`
                                        );
                            ...
                            <button
                                ...
                                onClick={async () => {
                                    ...
                                    const raw = selectedUserData.raw as CamperData;
                                    const fileName = `Contrato_PP_Menores_${raw.nombreCamper.replace(/\s+/g, '_')}.pdf`;
                            ...
                            <button
                                ...
                                onClick={async () => {
                                    ...
                                    toast.promise(async () => {
                                        ...
                                        const url = await uploadToZapSign(blob as Blob, `Contrato_PP_Menor_${raw.nombreCamper}.docx`);
                ...
                <DocxViewer
                    url="/contratos/Condiciones Específicas-Pronto Pago Menor de Edad.docx"
                    blob={previewBlob}
                />
            </div>
        </div>
