    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <div className="flex h-[calc(100vh-65px)]">
                            ...
                            <div className="p-3 bg-secondary/20 rounded-lg border border-border">
                                ...
                                <div className="flex gap-2 mb-3">
                                    ...
                                    <button
                                        ...
                                        onClick={() => {
                                            setModoPago('manual');
                                            // Inicializar con valores automáticos si está vacío
                        ...
                        <div className="grid grid-cols-2 gap-2 mt-2">
                                ...
                                onClick={async () => {
                                    ...
                                    try {
                                        ...
                                        await generateContract(
                                            "/contratos/Condiciones Específicas-Recursos Propios Menor de Edad.docx",
                                            data,
                                            `Contrato_RP_Menores_${raw.nombreCamper.replace(/\s+/g, '_')}.docx`
                                        );
                            ...
                            <button
                                ...
                                onClick={async () => {
                                    ...
                                    const raw = selectedUserData.raw as CamperData;
                                    const fileName = `Contrato_RP_Menores_${raw.nombreCamper.replace(/\s+/g, '_')}.pdf`;
                            ...
                            <button
                                ...
                                onClick={async () => {
                                    ...
                                    toast.promise(async () => {
                                        ...
                                        const url = await uploadToZapSign(blob as Blob, `Contrato_RP_Menor_${raw.nombreCamper}.docx`);
                ...
                {/* Document Viewer */}
                <DocxViewer
                    url="/contratos/Condiciones Específicas-Recursos Propios Menor de Edad.docx"
                    blob={previewBlob}
                />
            </div>
        </div>
