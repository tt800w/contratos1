  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="flex h-[calc(100vh-65px)]">
              ...
              onClick={async () => {
                ...
                try {
                  ...
                  await generateContract(
                    "/contratos/Condiciones Específicas- Estratos 5 y 6 - Mayor de Edad.docx",
                    data,
                    `Contrato_RP56_Mayores_${raw.nombreCamper.replace(/\s+/g, '_')}.docx`
                  );
            ...
            <button
              ...
              onClick={async () => {
                ...
                toast.promise(async () => {
                  ...
                  const url = await uploadToZapSign(blob as Blob, `Contrato_RP56_${raw.nombreCamper}.docx`);
        ...
        {/* Document Viewer */}
        <DocxViewer url="/contratos/Condiciones Específicas- Estratos 5 y 6 - Mayor de Edad.docx" blob={previewBlob} />
      </div>
    </div>
  );
};
